...
int solicitar_filas()
{
	...
	do
	{
		...
		cout << "Ingrese la cantidad de filas para el tablero (MAX=" << MAX << "), (MIN=2): ";
		cin >> filas;

		count++;

	} while (filas<2 || filas>MAX);
...
int solicitar_columnas()
{
	...
	do
	{
		...
		cout << "Ingrese la cantidad de columnas para el tablero (MAX=" << MAX << "), (MIN=2): ";
		cin >> columnas;

		count++;

	} while (columnas<2 || columnas>MAX);
...
int main()
{
	cout << "Buscaminas V1.5" << endl << "---------------" << endl;
...
ciclo_juego:
	...
	case 2:
	{
		...
		mostrar_tablero(mascara);
		cout << endl;
		cout << "Juego Terminado" << endl << "Usted pierde el juego, Mejor suerte la proxima";
		break;
	}
	}
